...
def show_notebooks():
    ...
    print('1. DC R Series')
    DC_R_Series().draw(style='european', draw_nodes=False,label_nodes=False,cpt_size=1,node_spacing=1.5)
    
    print('2. DC R Parallel')
    DC_R_Parallel().draw(style='european', draw_nodes=False,label_nodes=False,cpt_size=1,node_spacing=1.5)
    
    print('3. DC R Mixed')
    DC_R_Mixed().draw(style='european', draw_nodes=False,label_nodes=False,cpt_size=1,node_spacing=1.5)
    
    print('4. DC R Mixed long')
    DC_R_Mixed_long().draw(style='european', draw_nodes=False,label_nodes=False,cpt_size=1,node_spacing=1.5)
    
    print('5. DC C Series')
    DC_C_Series().draw(style='european', draw_nodes=False,label_nodes=False,cpt_size=1,node_spacing=1.5)
    
    print('6. DC C Parallel')
    DC_C_Parallel().draw(style='european', draw_nodes=False,label_nodes=False,cpt_size=1,node_spacing=1.5)
    
    print('7. DC C Mixed')
    DC_C_Mixed().draw(style='european', draw_nodes=False,label_nodes=False,cpt_size=1,node_spacing=1.5)
    
    print('8. DC C Mixed long')
    DC_C_Mixed_long().draw(style='european', draw_nodes=False,label_nodes=False,cpt_size=1,node_spacing=1.5)
    
    print('9. DC L Series')
    DC_L_Series().draw(style='european', draw_nodes=False,label_nodes=False,cpt_size=1,node_spacing=1.5)
    
    print('10. DC L Parallel')
    DC_L_Parallel().draw(style='european', draw_nodes=False,label_nodes=False,cpt_size=1,node_spacing=1.5)
    
    print('11. DC L Mixed')
    DC_L_Mixed().draw(style='european', draw_nodes=False,label_nodes=False,cpt_size=1,node_spacing=1.5)
    
    print('12. DC L Mixed long')
    DC_L_Mixed_long().draw(style='european', draw_nodes=False,label_nodes=False,cpt_size=1,node_spacing=1.5)
